...
import 'package:best/model/color.dart';
...
class ColorPage extends StatefulWidget {
  ...
  @override
  State<ColorPage> createState() => _PageState();
}
...
class _HomePageState extends State<HomePage> {
  ...
  Future<List> _loadData() async {
    listObs = await ColorAPI.getColors();
    return listObs;
  }
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                                onPressed: () async {
                                  await ColorAPI.deleteColorByID(
                                      snapshot.data![index]
                                      ['id']);
                                  setState(() {});
                                },
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton(
                ...
                onPressed: () async {
                  if (title == 'Add') {
                    var color = Colorss(0, nameCtrl.text);
                    await ColorAPI.addColor(color);
                  } else {
                    var color = Colorss(widget.ob['id'], nameCtrl.text);
